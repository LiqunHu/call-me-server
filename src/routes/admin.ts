...
import UserSettingControl from '@services/admin/user/UserSettingControl'

const router = express.Router()

router.post('/auth/OrganizationControl/:method', OrganizationControl)
router.post('/auth/OrganizationTemplateControl/:method', OrganizationTemplateControl)
...
router.post('/user/UserSetting/:method', UserSettingControl)
